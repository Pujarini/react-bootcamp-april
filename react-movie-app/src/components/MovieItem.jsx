...
import { BASE_URL } from "../constants/imgConstants";
  ...
  return (
    <div className="cursor-pointer p-2 group transition duration-200 ease-in transform hover:z-50 sm:hover:scale-105">
      ...
      <div className="p-2">
        ...
        <p className="flex items-center opacity-0 group-hover:opacity-100 hover:text-gray-500">
          {movie?.release_date}
          <svg
          ...
          {/* <HandThumbUpIcon className="h-5 bg-black" />s */}
          {movie?.vote_count}
        </p>
      </div>
    </div>
